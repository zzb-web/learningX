                        ...
                        <div className='select-info'>
                            ...
                            <div className='select-info-content'>
                                <div className='select-category'>
                                    <span>作业布置日期&nbsp;&nbsp;:</span>
                                    <DatePicker placeholder='作业是哪一天布置的？' style={{ width: 180, marginLeft:'10px',lineHeight:'28' }}/>
                                </div>
                                <div className='select-category'>
                                    <span>学习资料名称&nbsp;&nbsp;:</span>
                                ...
                                <div className='select-category'>
                                    <span>页码&nbsp;&nbsp;:</span>
                                    <InputNumber placeholder='作业是哪一页？' min={1} max={100} style={{ width: 180, marginLeft:'10px'}}/>
                                </div>
                                <div className='select-category'>
                                    <span></span>
                                    {
                                        !this.state.showDetail ? <Button type="primary" size='large' style={{width:180,height:35,marginLeft:'10px'}} onClick={this.sureBtnHandle.bind(this)}>确定</Button>
                                                                : null
                                    }
                                </div>
                            </div>
